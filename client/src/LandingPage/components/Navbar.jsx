...
import UserTypeSelection from './UserTypeSelection' // ✅ Added

const Navbar = () => {
    const [toggle, setToggle] = useState(false)
    const [showUserTypeModal, setShowUserTypeModal] = useState(false) // ✅ Added
    ...
    return (
        <>
            ...
            {showUserTypeModal && <UserTypeSelection onClose={closeUserTypeModal} />} {/* ✅ Modal Render */}
        </>
    )
}
